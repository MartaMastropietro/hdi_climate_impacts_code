...
for(o in c("gr_gnipc", "gr_leb", "gr_eys")){
  ...
  for (type in resp_types){
    ...
    save(results_all_glob, file=file.path(out_dir, paste0(o, "_", type, '_',spec,'_',vars, "_pop_w_nlags",NL,"_sobol_dec_glob.RData")))
...
for(o in c("gr_gnipc", "gr_leb", "gr_eys")){
  ...
  load(file.path(out_dir, paste0(o, "_", type, '_',spec,'_',vars, "_pop_w_nlags",NL,"_sobol_dec_glob.RData")))
  ...
  ggsave(file.path(out_dir, paste0(o, "_", type, '_',spec,'_',vars, "_pop_w_nlags",NL,"_sobol_dec_glob.png")), plot = g, width = 15, height = 5, dpi = 150)
