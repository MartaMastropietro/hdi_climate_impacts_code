...
data<-arrow::read_feather(file.path(out_dir_lag,
                                    paste0(out_var,'_',spec,'_',type,'_',  agg,"_nlags",N, "_",vars, 
...
arrow::write_feather(data_int,file.path(out_dir_lag,
                                        paste0(out_var ,'_values_deltas_',
                                               spec,'_',type,'_',  agg,"_nlags",N,  "_",vars, 
                                               "_boot_int" , ".feather")) )
...
arrow::write_feather(data,file.path(out_dir_lag,
                                    paste0(out_var ,'_values_deltas_',spec,'_',type,'_',  agg,"_nlags",N,  "_",vars, 
                                           "_boot_impacts_all" , ".feather")) )
...
write.csv(x=data_iso, file=file.path(out_dir_lag,paste0('c_sel_agg_',out_var,"_",type,'_',spec,'_',vars, "_pop_weight_nlags_",N, "_",vars, "_boot_all.csv")), row.names = FALSE)
...
write.csv(x=data_glob, file=file.path(out_dir_lag,paste0('g_agg_',out_var,"_",type,'_',spec,'_',vars, "_pop_weight_nlags_",N, "_",vars, "_boot_all.csv")), row.names = FALSE)
