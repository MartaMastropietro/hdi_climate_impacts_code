...
### try
o<-"gr_gnipc"
data_int_gnipc<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',type,'_',  agg, "_nlags",N,"_",vars, 
                                                                 "_boot_intervals" , ".feather")))
# to uncomment
data_all_gnipc<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',type,'_',  agg, "_nlags",N,"_",vars, 
                                                                 "_boot_all" , ".feather")))
data_int_gnipc<-inner_join(data_int_gnipc, pop_projection_gdlcode )
gc()
o<-"gr_leb"
data_int_leb<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',type,'_',  agg, "_nlags",N,"_",vars, 
                                                               "_boot_intervals" , ".feather")))
# to uncomment
data_all_leb<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',type,'_',  agg, "_nlags",N,"_",vars, 
                                                               "_boot_all" , ".feather")))
data_int_leb<-inner_join(data_int_leb, pop_projection_gdlcode )
gc()
o<-"gr_eys"
data_int_eys<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',type,'_',  agg, "_nlags",N,"_",vars, 
                                                               "_boot_intervals" , ".feather")))
# to uncomment
data_all_eys<-arrow::read_feather(file.path(out_dir_lag,paste0(o,'_',spec,'_',type,'_',  agg, "_nlags",N,"_",vars, 
                                                               "_boot_all" , ".feather")))
...
arrow::write_feather(data_hdi,file.path(out_dir_lag,
                                        paste0('hdi_',spec,'_',type,'_',  agg,"_nlags",N, "_",vars, 
                                               "_boot_impacts_all" , ".feather")) )

gc()

arrow::write_feather(data_all_gnipc,file.path(out_dir_lag,
                                              paste0('income_index_',spec,'_',type,'_',  agg,"_nlags",N, "_",vars, 
                                                     "_boot_impacts_all" , ".feather")) )

gc()

arrow::write_feather(data_all_eys,file.path(out_dir_lag,
                                            paste0('edu_index_',spec,'_',type,'_',  agg,"_nlags",N, "_",vars, 
                                                   "_boot_impacts_all" , ".feather")) )


gc()
arrow::write_feather(data_all_leb,file.path(out_dir_lag,
                                            paste0('lifex_index_',spec,'_',type,'_',  agg,"_nlags",N, "_",vars, 
                                                   "_boot_impacts_all" , ".feather")) )
