...
for (spec in specs){
  ...
  r=paste0(mean_cl_formula,"+", 
           extr_formula, "+",
           # contr
           "l(gr_eys, 0:6)+ l(gr_gnipc, 0:6)+ l(conflict, 0:6) + l(exp_health, 0:6) + l(trade, 0:6) + l(exp_edu, 0:6)"
  )
  ...
  r=paste0(mean_cl_formula,"+", 
           extr_formula, "+",
           # contr
           "l(gr_eys, 0:6)+l(gr_leb, 0:6)+ l(conflict, 0:6) + l(exp_health, 0:6) + l(trade, 0:6) + l(exp_edu, 0:6)"
  )
